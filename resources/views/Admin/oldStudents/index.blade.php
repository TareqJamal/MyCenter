...
@section('js')
    ...
    <script>
        ...
        $('#dataTable').on('click', '#btnDelete', function () {
            Swal.fire({
                text: 'هل انت متاكد من حذف نهائي هذا الطالب',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    ...
                    var url = "{{route('old-students.destroy','studentId')}}"
        ...
        $('#dataTable').on('click', '#btnRestore', function () {
            var studentId = $(this).data('id');
            var url = "{{route('old-students.edit',':studentId')}}"
            url = url.replace(':studentId', studentId);
            $.ajax({
                url: url,
                success: function (response) {
